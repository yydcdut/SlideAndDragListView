 ...
 */
class ItemMainLayout2 extends FrameLayout {
    ...
    public ItemMainLayout2(Context context) {
        this(context, null);
    }

    public ItemMainLayout2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ItemMainLayout2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void deleteItem(final OnItemDeleteListenerProxy onItemDeleteListenerProxy) {
        ...
        Animation.AnimationListener animationListener = new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                if (onItemDeleteListenerProxy != null) {
                    onItemDeleteListenerProxy.onDelete(ItemMainLayout2.this);
                }
            }
        ...
        Animation animation = new Animation() {
            ...
            protected void applyTransformation(float interpolatedTime, Transformation t) {
                ...
                ItemMainLayout2.this.requestLayout();
            }
