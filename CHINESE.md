...
更新日志: <a href="https://github.com/yydcdut/SlideAndDragListView/blob/master/CHANGELOG.md">CHINESE.md</a>
...
``` groovy
compile 'com.yydcdut.sdlv:sdlv:0.5.3@aar'
```
