...
/**
 * Created by yuyidong on 2018/4/22.
 */
public class PullRefreshWithSDLVActivity extends AppCompatActivity implements AdapterView.OnItemLongClickListener,
    ...
    private static final String TAG = PullRefreshWithSDLVActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initMenu();
        initUiAndListener();
        mToast = Toast.makeText(PullRefreshWithSDLVActivity.this, "", Toast.LENGTH_SHORT);
    ...
    private BaseAdapter mAdapter = new BaseAdapter() {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(PullRefreshWithSDLVActivity.this).inflate(R.layout.item_custom_btn, null);
